...
describe('Pruebas en el hook useFetchGifs', () => {
  test('Debe regresar el estado inicial', () => { // si no se ha cargado nada isLoading debe ser true y images vacio
  ...
  test('Debe de retornar un arreglo de imagenes y isLoading en false', async () => {
    ...
    await waitFor(() => { // waitFor espera a que se resuelva la promesa
